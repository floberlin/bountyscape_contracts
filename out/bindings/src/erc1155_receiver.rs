...
pub mod erc1155_receiver {
    ...
    #[doc = "ERC1155Receiver was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    impl<M> Clone for ERC1155Receiver<M> {
        fn clone(&self) -> Self {
            ERC1155Receiver(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for ERC1155Receiver<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware> std::fmt::Debug for ERC1155Receiver<M> {
    ...
    impl<M: ethers::providers::Middleware> ERC1155Receiver<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), ERC1155RECEIVER_ABI.clone(), client)
                .into()
        }
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for ERC1155Receiver<M> {
    ...
    impl ethers::core::abi::AbiDecode for ERC1155ReceiverCalls {
        fn decode(
            ...
            {
                return Ok(ERC1155ReceiverCalls::OnERC1155BatchReceived(decoded));
            }
            if let Ok(decoded) =
                <OnERC1155ReceivedCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(ERC1155ReceiverCalls::OnERC1155Received(decoded));
            }
            if let Ok(decoded) =
                <SupportsInterfaceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(ERC1155ReceiverCalls::SupportsInterface(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for ERC1155ReceiverCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ERC1155ReceiverCalls::OnERC1155BatchReceived(element) => element.encode(),
                ERC1155ReceiverCalls::OnERC1155Received(element) => element.encode(),
                ERC1155ReceiverCalls::SupportsInterface(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for ERC1155ReceiverCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ERC1155ReceiverCalls::OnERC1155BatchReceived(element) => element.fmt(f),
                ERC1155ReceiverCalls::OnERC1155Received(element) => element.fmt(f),
                ERC1155ReceiverCalls::SupportsInterface(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<OnERC1155BatchReceivedCall> for ERC1155ReceiverCalls {
        fn from(var: OnERC1155BatchReceivedCall) -> Self {
            ERC1155ReceiverCalls::OnERC1155BatchReceived(var)
        }
    }
    impl ::std::convert::From<OnERC1155ReceivedCall> for ERC1155ReceiverCalls {
        fn from(var: OnERC1155ReceivedCall) -> Self {
            ERC1155ReceiverCalls::OnERC1155Received(var)
        }
    }
    impl ::std::convert::From<SupportsInterfaceCall> for ERC1155ReceiverCalls {
        fn from(var: SupportsInterfaceCall) -> Self {
            ERC1155ReceiverCalls::SupportsInterface(var)
        }
    }
