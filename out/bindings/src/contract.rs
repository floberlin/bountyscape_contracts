...
pub mod contract {
    ...
    pub static CONTRACT_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea264697066735822122018fa82fabcc96644d1fe3d079d477da1adf085c8ed54b43406d435f0586f356864736f6c634300080f0033" . parse () . expect ("invalid bytecode")
        });
